      ...
      <div  className="chatbox container-fluid bg-white shadow-lg rounded">
        <div className="row h-100">
          ...
          >
              ...
              <div className="card-header h-100">
                <div className="row">
                  {/* <div className="col-1 col-sm-1 col-md-1 d-md-none">
                    <i onClick={()=>setaddclass(true)} className="fas fa-list mt-2" style={{fontSize:'20px',cursor:'pointer'}}></i>
                  </div> */}
            ...
            <ChatList currentUser={currentUser} LoadFriendList={LoadFriendList} CurrentUserID={CurrentUserID}
           ...
           id='side-2'>
          {
            ...
            :
            <ChatPage Messages={Messages} LoadChatMessages={LoadChatMessages} CurrentMessageID={CurrentMessageID} 
